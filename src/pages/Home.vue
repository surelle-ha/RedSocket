...
import Metrics from '@/widgets/Metrics.vue'
import SocketEvents from '@/widgets/SocketEvents.vue'
import SocketEventStatistics from '@/widgets/SocketEventStatistics.vue'
</script>

<template>
	<main class="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
		<Metrics />
		<div class="grid gap-4 md:gap-8 lg:grid-cols xl:grid-cols">
